...
int main()
{
    ...
    {
        new Student("Rajib","20-6-1996",department,"102356"),
        new Student("Rakib","13-3-1998",department,"102357"),
        new Student("Akkas","21-11-1996",department,"102358"),
        new Student("Galib","05-07-1997",department,"102359")
    };

    Sellsman sells_person("Mamun Ahmed","13-03-1985",1);
    ...
    {
        new Faculty("Professor","Saeed Hasan",department,login_data[0]),
        new Faculty("Lecturer","Nahid Islam",department,login_data[1])
    };
    for(int i=0;i<3;i++)
